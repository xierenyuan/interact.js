...
export declare class Scope {
    ...
    events: {
        add: (element: EventTarget, type: string, listener: (event: Event | import("@interactjs-fork/utils/events").FakeEvent) => any, optionalArg?: any) => void;
        remove: (element: EventTarget, type: string, listener?: ((event: Event | import("@interactjs-fork/utils/events").FakeEvent) => any) | "all", optionalArg?: any) => void;
        addDelegate: (selector: string, context: Node, type: string, listener: (event: Event | import("@interactjs-fork/utils/events").FakeEvent) => any, optionalArg?: any) => void;
        removeDelegate: (selector: string, context: Document | HTMLElement | SVGElement, type: string, listener?: (event: Event | import("@interactjs-fork/utils/events").FakeEvent) => any, optionalArg?: any) => void;
        ...
        delegatedEvents: {
            [type: string]: {
                selectors: string[];
                contexts: Node[];
                listeners: [(event: Event | import("@interactjs-fork/utils/events").FakeEvent) => any, boolean, boolean][][];
            };
        };
        documents: Document[];
        ...
        _targets: {
            events: {
                [type: string]: ((event: Event | import("@interactjs-fork/utils/events").FakeEvent) => any)[];
            };
            typeCount: number;
        }[];
