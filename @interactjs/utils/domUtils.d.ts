...
export declare function closest(element: Node, selector: string): import("@interactjs-fork/types/types").Element;
...
export declare function getActualElement(element: Interact.Element): import("@interactjs-fork/types/types").Element;
